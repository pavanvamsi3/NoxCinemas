...
public class Profile_1 extends javax.swing.JFrame {
    ...
    public Profile_1() {
        try {
            ...
            rs = s.executeQuery("SELECT * FROM THEATRE");
            ...
            Logger.getLogger(Profile_1.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void Profile_LabelMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Profile_LabelMouseExited
        Profile_Label.setForeground(Color.WHITE);
    }//GEN-LAST:event_Profile_LabelMouseExited
